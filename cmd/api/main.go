...
func main() {
	...
	// สร้าง DSN สำหรับเชื่อมฐานข้อม฿ล
	...
	// flag.StringVar(&app.DSN, "dsn", "host=localhost port=5432 dbname=gosampledb user=postgres password=postgres sslmode=disable timezone=UTC connect_timeout=5", "Postgres connection string")

	// //Parse the command line argument for JWT
	// flag.StringVar(&app.JWTSecret, "jwt-secret", "qwertyuiopasdfghjkllzxcvbnm", "signing secret")
	...
	fmt.Println("String server on", app.Domain)
